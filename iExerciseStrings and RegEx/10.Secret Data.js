function secretData(input) {
    let nameRegex = /\*[A-Z]{1}[a-zA-Z]*(?= |\t|$)/g;//\*[A-Z]{1}[a-zA-Z]+
...
secretData(["Agent *Ivankov was in the room when it all happened.",
            ...
            "He said something about \"finishing work\" with subject !2491a23BVB34Q and returning to Base _Aurora21 Then after that he disappeared from my sight.",
